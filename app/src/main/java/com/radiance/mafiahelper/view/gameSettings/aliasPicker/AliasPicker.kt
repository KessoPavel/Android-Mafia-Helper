package com.radiance.mafiahelper.view.gameSettings.aliasPicker
...
import com.radiance.mafiahelper.view.gameSettings.aliasPicker.adapter.AliasAdapter
...
class AliasPicker : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        setUpToolbar(mainToolbar, R.string.choose_the_order_of_the_players)
    }
